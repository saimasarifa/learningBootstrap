...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        $('.theme-setting-layouts', panel).change(function(){
            Index.redrawCharts();  // reload the chart on layouts width change
        });
    };
    ...
    return {
        ...
        init: function() {
            ...
            if ($.cookie && $.cookie('layouts-style-option') === 'rounded') {
                ...
                $('.theme-panel .theme-setting-style').val($.cookie('layouts-style-option'));
            }            
        }
    };
