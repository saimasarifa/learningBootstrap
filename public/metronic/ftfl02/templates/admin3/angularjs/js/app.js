...
MetronicApp.factory('settings', ['$rootScope', function($rootScope) {
    ...
    var settings = {
        ...
        layoutImgPath: Metronic.getAssetsPath() + 'admin/layouts/img/',
        layoutCssPath: Metronic.getAssetsPath() + 'admin/layouts/css/'
    };
...
<<<<<<< HEAD
        //Layout.init(); //  Init entire layout(header, footer, sidebar, etc) on page load if the partials-todoTask included in server side instead of loading with ng-include directive
=======
<<<<<<< HEAD
        //Layout.init(); //  Init entire layout(header, footer, sidebar, etc) on page load if the partials-blog included in server side instead of loading with ng-include directive
=======
        //Layout.init(); //  Init entire layout(header, footer, sidebar, etc) on page load if the partials-about included in server side instead of loading with ng-include directive
...
Layout Partials.
<<<<<<< HEAD
By default the partials-todoTask are loaded through AngularJS ng-include directive. In case they loaded in server side(e.g: PHP include function) then below partial
=======
<<<<<<< HEAD
By default the partials-blog are loaded through AngularJS ng-include directive. In case they loaded in server side(e.g: PHP include function) then below partial
=======
<<<<<<< HEAD
By default the partials-about are loaded through AngularJS ng-include directive. In case they loaded in server side(e.g: PHP include function) then below partial
=======
<<<<<<< HEAD
By default the partials are loaded through AngularJS ng-include directive. In case they loaded in server side(e.g: PHP include function) then below partial-contactus
=======
By default the partials are loaded through AngularJS ng-include directive. In case they loaded in server side(e.g: PHP include function) then below partial-faq
